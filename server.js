...
mongoose.connect("mongodb://localhost/hustleScraper", {
  useMongoClient: true
});
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://thehustle.co/series/brief/").then(function(response) {
...
// Add articles to Saved section
app.post("/articles/:id", function(req, res) {
  db.Article
    .findOneAndUpdate({ _id: req.params.id }, { saved: req.body.saved }, { new: true })
    .then(function(dbArticle) {
      res.json(dbArticle);
    })
    .catch(function(err) {
